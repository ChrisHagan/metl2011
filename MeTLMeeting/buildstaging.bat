...
:NOPUBLISH
msbuild.exe MeTL.sln /l:FileLogger,Microsoft.Build.Engine;logfile=MeTLBuildLog.log /p:Configuration=Debug /p:Platform="Any CPU" /p:ApplicationRevision=%1 /t:Clean;Build
GOTO SUCCESS
