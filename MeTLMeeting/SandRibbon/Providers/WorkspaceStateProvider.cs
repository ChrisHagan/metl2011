...
namespace SandRibbon.Providers
{
    ...
    {
        private static readonly string WORKSPACE_DIRECTORY = LocalFileProvider.getUserFolder("Workspace");// "Workspace";
        private static readonly string WORKSPACE_SAVE_FILE = WORKSPACE_DIRECTORY+"state.xml";//string.Format(@"{0}\state.xml",WORKSPACE_DIRECTORY);
