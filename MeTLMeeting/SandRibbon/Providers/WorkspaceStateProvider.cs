...
namespace SandRibbon.Providers
{
    public class WorkspaceStateProvider
    {
        ...
        public WorkspaceStateProvider(NetworkController _controller)
        {
            controller = _controller;
        }
        private readonly string WORKSPACE_DIRECTORY = LocalFileProvider.getUserFolder("Workspace");
        private readonly string WORKSPACE_SAVE_FILE = LocalFileProvider.getUserFile(new string[] { "Workspace" }, "state.xml");
        private readonly string WORKSPACE_ROOT_ELEMENT = "workspace";
        private readonly string WORKSPACE_PREFERENCE_ELEMENT = "preference";
        public readonly string WORKSPACE_COMMAND_ATTRIBUTE = "command";
        public readonly string WORKSPACE_PARAMETER_ELEMENT = "parameter";
        private readonly IEnumerable<CompositeCommand> workspaceCommands = new CompositeCommand[]{
        };
        ...
        public void ensureWorkspaceDirectoryExists()
        {
