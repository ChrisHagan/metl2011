...
namespace SandRibbon.Components
{
    ...
    public partial class CircularProgressBar
    {
        ...
        {
            ellipse.SetValue(System.Windows.Controls.Canvas.LeftProperty, 50 + (Math.Sin(offset + (posOffSet * step)) * 50));
            ellipse.SetValue(System.Windows.Controls.Canvas.TopProperty, 50 + (Math.Cos(offset + (posOffSet * step)) * 50));
        }
