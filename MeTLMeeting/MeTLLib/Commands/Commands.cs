...
namespace MeTLLib
{
    ...
    public class Commands
    {
        ...
        {
            return (DefaultableCompositeCommand)typeof(Commands).GetField(name).GetValue(this);
        }
    ...
    {
        public static object lastValue(this CompositeCommand command,Commands commands)
        {
